// function checkDateHopLe (day, month, year){
...
// //2
// n=prompt(`Nhap ten nguoi dung:`,'Nguyen A')
// for (let i=0; i<users.length; i++){
//     if (users[i].first_name==n || users[i].last_name){
//         console.log(users[i].email)
//     }
// }
// //3
// let countUsersOlderThan50=0;
// for (let i=0; i<users.length; i++){
//     if (users[i].age>50){
//         countUsersOlderThan50+=1;
//     }
//     }
// console.log("Number of users>50:",countUsersOlderThan50)

// //4 
// let countUsersMarried=0;
// for (let i=0; i<users.length; i++){
//     if (users.is_married){
//         countUsersMarried+=1
//     }
// }
// console.log("Number of users married:",countUsersMarried)
// console.log("Numer of users NOT married:",users.length-countUsersMarried)

// // //5
// // let usersJob=[];
// // for (let i=0; i<users.length; i++){
// //     if (usersJob.includes(users[i].job)==false){
// //         usersJob.push(users[i].job)
// //     } 
// // }
// // console.log(usersJob);
// // const result = {};
// // for (let j=0;j<usersJob.length; j++){
// //     countJob=0;
// //     for (let x=0; x<users.length; x++){
// //         if (users[x].job==usersJob[j]){
// //             countJob+=1;
// //         }
// //     }
// //     result[usersJob[j]]= countJob;
// //     }   
// // console.log(result)
...
console.log('BT5')
let result={};
// hasOwnProperty check if an object has that property
